 ...
 * @fn      HalReadTemp
 *
 * @brief   Read the temperature sensor using the ADC
 *
 * @return  The 16 bit temperature value of the ADC.
 **************************************************************************************************/
uint16 HalReadTemp ( void )
{
  uint16 value;
 ...
 * @fn      HalReadVdd
 *
 * @brief   Read the bus voltage using the ADC
 *
 * @return  The 16 bit voltage value of the ADC.
 **************************************************************************************************/
uint16 HalReadVdd ( void )
{
  uint16 value;
