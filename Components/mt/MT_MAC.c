/**************************************************************************************************
  Filename:       MT_MAC.c
  Revised:        $Date: 2014-08-26 15:58:13 -0700 (Tue, 26 Aug 2014) $
  Revision:       $Revision: 39892 $
...
void MT_MacGetReq(uint8 *pBuf)
{
  ...
  /* TODO - is there an automated way to always find the largest PIB attribute? */
  respLen = MAC_RANDOM_SEED_LEN + 1;
